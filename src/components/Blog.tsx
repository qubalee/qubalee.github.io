...
const Blog = () => {
  ...
  const { tagline } = useSiteInfo();
  const headingText = isArchive ? blogLabel : blogLabel || "Notes";
  ...
  return (
    <section
      id="blog"
      className={
        isArchive ? "pt-0 md:pt-6 pb-2 bg-background" : "pt-0 pb-6 md:pt-2 md:pb-8 bg-background"
      }
    >
